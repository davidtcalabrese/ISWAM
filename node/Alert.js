 ...
 */
 class Alert {
   ...
   */
  static getAlertFromCode = async code => {
   ...
   */
  static getAlertFields = alertProperties => {
    const alertProps = [];
   ...
   */
  static getCoordsFromZip = async function (zip) {
   ...
   */
  static getCodeFromCoords = async function (lat, long) {
   ...
   */
  static processAlert = async (zip, severityThreshold) => {
   ...
   */
  static isSevereEnough = severityThreshold => {
